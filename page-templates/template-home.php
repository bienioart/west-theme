...
<div class="home-hero-banner-top">
	<div class="container">
		<div class="row align-items-end">
			...
			<div class="home-hero">
									<img src="<?php echo get_template_directory_uri(); ?>/img/home-hero-right-info.png" alt="home-hero" width="100%">
		...
		<div class="container">
			<div class="home-special-offer">
				...
				<div class="entry-content">
					...
					<div class="desc">BIN SERVICES - Perth, Fermantle, Kwianana, Rockingham, Mandurah, Pinjarra, Waroona, Harvey, Australid, Bunbury, Busselton, Margaret River</div>
